...
char sensor[6] = {0, 0, 0, 0, 0,0}; // Leitura "digital" dos sensores
...
void writeValues(void); // funcao para usar o processing para verificar funcionamento dos sensores
